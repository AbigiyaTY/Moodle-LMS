...
class __Mustache_e99962c64165519b852f2d41a92a9b89 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section77006fd962d393931798408ef1c31332($context, $indent, $value);
...
';
            ...
            if (empty($value)) {
                ...
                $buffer .= $indent . '            <div class="section-header d-flex flex-column">
';
...
';
            ...
            $buffer .= $this->section8c8464008e35ffbe638b8389c5274143($context, $indent, $value);
            $buffer .= $indent . '    </div>
';
            $buffer .= $indent . '</li>
';
...
';
    ...
    private function section77006fd962d393931798408ef1c31332(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionEf2ec7f100380caedcefb69cc9c4f652(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section8c8464008e35ffbe638b8389c5274143(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionEf2ec7f100380caedcefb69cc9c4f652($context, $indent, $value);
                $value = $context->find('percentage');
                if (empty($value)) {
